...
class BaselineAndMetricsTests(unittest.TestCase):
    def test_a11_single_worker_suffices(self):
        # A11: "Все заявки выполнимы одним worker; два дают немного меньше пути" -> При равном покрытии выбирается один
        ...
        # But wait! "два дают немного меньше пути" means 2 vehicles give LESS travel, but 1 is chosen because W_VEHICLE is large.
        ...
        matrix[0][2] = 10; matrix[2][0] = 10
        matrix[2][3] = 10; matrix[3][2] = 10
        matrix[3][0] = 10; matrix[0][3] = 10
    ...
    def test_a24_greedy_trap(self):
        ...
        # Baseline gets stuck because it takes the first eligible, preventing a globally optimal assignment.
        data = problem(n=4, vehicles=2, horizon=100)
        ...
        # Let's say Task 2 allowed for [1, 0] so it checks v1 first! Wait,allowed_vehicles is a dict of lists.
