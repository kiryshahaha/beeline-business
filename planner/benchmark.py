...
def generate_synthetic_problem(seed: int, n_tasks: int, n_vehicles: int, time_limit_s: int = 5) -> dict:
    random.seed(seed)
    ...
    for i in range(n_vehicles, n):
        ...
        ticket_policies.append(TicketPolicy(
            ticket_id=1000 + i,
            category=cat,
            priority=priority,
    ...
    with open("benchmark_report.json", "w") as f:
        json.dump({
            ...
            "solver": {
                ...
                "objective_components": res_solver.objective_components.model_dump() if res_solver.objective_components else None
            }
        }, f, indent=2)
