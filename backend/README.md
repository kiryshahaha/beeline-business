...
реализованы тип транспорта исполнителя, история маршрутов в GeoJSON и единый импорт/экспорт
всех предметных таблиц CSV/XLSX.
...
справочник не входит: он одинаков в каждой базе, а импорт добавлял бы его строки повторно.
...
| `15-work-types` | Справочник видов работ: список с проверкой суммы норматива, чтение исполнителем по ID, `404` и `401` без токена |
