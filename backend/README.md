...
├── bruno/                    # коллекция HTTP-запросов и проверок Bruno (01–16)
└── README.md
```
...
| `16-reports` | Экспорт заявок наблюдателем в CSV и XLSX, фильтры, формат по умолчанию и проверки `401`/`403`/`422` |
...
Bruno покрывает HTTP-маршруты в папках `05-auth`–`09-routing`, `15-work-types` и
`16-reports`.
