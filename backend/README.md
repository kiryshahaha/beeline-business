...
справочник видов работ с нормативами времени (миграции `0001`–`0009`).
...
Таблица `work_types` хранит виды работ из файла организаторов «Нормативы.xlsx». Миграция `0009`
создаёт таблицу и сразу добавляет четыре строки; через API справочник только читается.
Названия сохранены так, как они записаны в файле, включая «Аварий на ТКД».
...
| `12-work-types` | Справочник видов работ: список с проверкой суммы норматива, чтение исполнителем по ID, `404` и `401` без токена |
